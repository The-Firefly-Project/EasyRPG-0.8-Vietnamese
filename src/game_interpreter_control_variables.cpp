...
int ControlVariables::Item(int op, int item) {
	...
	Output::Warning("ControlVariables::Item: Không xác định được op {}", op);
	return 0;
}
...
int ControlVariables::Actor(int op, int actor_id) {
	...
	if (!actor) {
		Output::Warning("ControlVariables::Actor: ID nhân vật {} không hợp lệ", actor_id);
		return 0;
	}
	...
	Output::Warning("ControlVariables::Actor: Không xác định được op {}", op);
	return 0;
}
...
int ControlVariables::Party(int op, int party_idx) {
	...
	if (!actor) {
		Output::Warning("ControlVariables::Party: party_idx {} không hợp lệ", party_idx);
		return 0;
	}
...
int ControlVariables::Event(int op, int event_id, const Game_Interpreter& interpreter) {
	...
	if (character) {
		...
		Output::Warning("ControlVariables::Event: Không xác định được op {}", op);
	} else {
		Output::Warning("ControlVariables::Event: ID sự kiện {} không hợp lệ", event_id);
	}
...
int ControlVariables::Other(int op) {
	...
	Output::Warning("ControlVariables::Other: Không xác định được op {}", op);
	return 0;
}
...
int ControlVariables::Enemy(int op, int enemy_idx) {
	...
	if (!enemy) {
		Output::Warning("ControlVariables::Enemy: enemy_idx {} không hợp lệ", enemy_idx);
		return 0;
	}
	...
	Output::Warning("ControlVariables::Enemy: Không xác định được op {}", op);
	return 0;
}
...
int ControlVariables::Binary(int op, int arg1, int arg2) {
	...
	switch (op) {
		...
		case 10:
			...
			break;
		default:
			Output::Warning("ControlVariables::Binary: Không xác định được op {}", op);
			return 0;
	}
