...
#define MTINI_EXVOCAB_IMPORT_SAVE_HELP_VALUE "Nhập bản lưu có sẵn"
#define MTINI_EXVOCAB_IMPORT_SAVE_TITLE_KEY "Vocab_ImportSave"
#define MTINI_EXVOCAB_IMPORT_SAVE_TITLE_VALUE "Nhập bản lưu"
...
Meta::Meta(StringView meta_file) {
	...
	if (!Empty()) {
		...
		if (version == "1") {
			...
			Output::Warning("Lỗi dữ liệu ở tệp tin {}, định dạng thuộc tính {}:{} không được tìm thấy hoặc không hợp lệ: '{}'", meta_file, MTINI_EASY_RPG_SECTION, MTINI_FILE_FORMAT_VERSION, version);
			ini = nullptr;
		}
	}
